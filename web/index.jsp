...
<div align="center">
  <h1 class="container">欢迎来到派蒙银行</h1>
</div>
...
<form action="AccountAddServlet" method="get">
  <table>
    ...
    <tr>
      ...
      <td>
          <div>
              ...
              <input type="text" name="id" id="id" class="form-control" placeholder="100001" required="" autofocus="">
          </div>
      </td>
    </tr>
    ...
    <td><div><a href="login.jsp">如果已经注册，请点击此处登录</a></div></td>
</form>
</div>
